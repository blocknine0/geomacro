...
describe(
  ...
  () => {
    it(
      'independently reproduces score, hashes and exact change attribution',
      () => {
    ...
    it(
      'reports internal reproducibility separately from issuer authenticity',
      () => {
        const report =
          verifyPortableGriProofBundle(
            fixtureBundle(),
    ...
    it(
      'detects calculation contribution tampering',
      () => {
        const bundle = fixtureBundle();
        const tampered =
    ...
    it(
      'detects mathematical attribution tampering',
      () => {
        const bundle = fixtureBundle();
        const tampered =
          structuredClone(bundle);
    ...
    it(
      'rejects a wrong trusted proof hash even when the bundle is internally reproducible',
      () => {
        const bundle = fixtureBundle();
        const report =
          verifyPortableGriProofBundle(
