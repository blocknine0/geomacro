...
describe("distributed 40k observability closure", () => {
  ...
  it("requires dedicated provider observability rather than inferring infrastructure health", () => {
    ...
    expect(telemetry).toContain("upstream_providers.saturation_events");
