...
Geomacro is currently in an early commercialization stage.
...
| Ask Geomacro | LIVE |
| Risk API / signed Risk Objects | PRIVATE PILOT |
...
Private Pilot Risk Gate remains non-authorizing with `execution_authorized=false`; customer identity, permissions, policy, funds and downstream execution remain customer-controlled.

Contact `contact@geomacro.live` for a controlled pilot or institutional conversation.
