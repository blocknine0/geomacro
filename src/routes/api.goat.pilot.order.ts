      ...
      POST: async ({ request }) => {
        ...
        if (
          !allowPublicDemoRequest(request, {
            namespace: "goat-partner-pilot-order",
            windowMs: 60_000,
            maxPerClient: 20,
            maxGlobal: 120,
          })
          ...
          return response(
            {
              ...
              error: {
                ...
                message: "GOAT partner-pilot request limit exceeded. Retry shortly.",
              },
              execution_authorized: false,
            },
            429,
            ...
            return response(
              {
                ok: false,
                error: {
                  code: "INVALID_GOAT_PILOT_REQUEST",
        ...
        let input;
        try {
          input = goatPilotCreateOrderSchema.parse(raw);
        } catch (error) {
            ...
            return response(
              {
                ...
                error: {
                  code: "INVALID_GOAT_PILOT_REQUEST",
                  message: "GOAT partner-pilot request fields are invalid.",
        ...
        try {
          ...
          console.error("[goat-pilot] order endpoint failed closed", error);
          return response(
            {
              ok: false,
              error: {
                code: "GOAT_PILOT_INTERNAL_ERROR",
                message: "GOAT partner-pilot order could not be prepared.",
              },
              execution_authorized: false,
            },
            503,
