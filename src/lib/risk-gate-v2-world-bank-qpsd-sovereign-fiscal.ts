...
/**
 * Source-specific QPSD sovereign-fiscal module-state builder.
 *
 * This validates the exact QPSD concept, source proof, comparable peer universe,
 * freshness and deterministic normalized signal. It does not itself decide
 * whether QPSD is available in production. Production serving is separately
 * gated in risk-gate-v2-world-bank-qpsd-sovereign-fiscal.server.ts by the exact
 * source registration, commercial-signal state, clean release manifest and
 * persisted provenance. General-government and central-government debt are
 * never raw-value pooled, and QPSD is never pooled with WDI or Eurostat.
 */
