...
export const GEOMACRO_ACCESS_TIERS = {
  free: {
    ...
    structured_data: {
      ...
      provenance_mode: "opaque_internal_provenance_only",
      bulk_export: false,
...
export const GEOMACRO_DATA_POLICY = {
  ...
  upstream_news_source_url_disclosed: false,
