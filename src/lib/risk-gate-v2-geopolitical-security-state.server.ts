...
/**
 * Production adapter for the current UCDP Candidate geopolitical-security
 * module. A clean release manifest is mandatory. Countries with a PARTIAL or
 * otherwise non-commercial row in that same release fail closed individually.
 */
