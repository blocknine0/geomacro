...
<meta name="description" content="Test Geomacro's canonical geopolitical and macro intelligence capabilities with pay-per-call Testnet USDC." />
<style>
...
<body>
<main>
  <div class="nav"><div class="brand"><img src="/__l5e/assets-v1/9118c3e7-7750-4173-90cc-dd0445585e92/geomacro-logo.png" alt="Geomacro" height="40" /></div><div class="badge">TESTNET · PAY PER CALL</div></div>
  <section class="hero">
    <div class="eyebrow">CANONICAL INTELLIGENCE PIPELINE</div>
    <h1>Test the same intelligence layer used by Geomacro products.</h1>
    <p class="muted">Requests are served from Geomacro's structured intelligence state: stored intelligence, the verified Global Risk Index, governed structural context, signed Risk Objects and Risk Gate. Each capability has a fixed credit cost. One credit costs 0.5 Testnet USDC, paid only when that API call is used.</p>
    <p class="muted"><a href="/testnet-access">Back to Testnet account and developer credentials</a></p>
  </section>
  <section id="consoleAnchor" class="panel">
    <div class="eyebrow">ACCOUNT CHECK</div>
    <p class="muted">If your wallet-verified Testnet tester access is active, the console appears below automatically. The 500 credits are a 30-day usage cap, not a prepaid balance.</p>
  </section>
</main>
</body>
</html>`;
