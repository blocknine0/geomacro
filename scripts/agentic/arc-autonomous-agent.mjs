...
if (parsedMaxAmount < Number(accept.amount) / 1_000_000) {
  fail(`GEOMACRO_AGENT_MAX_PAYMENT_USDC must cover the advertised ${Number(accept.amount) / 1_000_000} USDC request.`);
}
