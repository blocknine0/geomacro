 ...
 * - three product domains have equal base weight; missing domains are excluded,
...
export const GRI_CATEGORIES = ["geopolitics", "macro", "rare_earth"];
