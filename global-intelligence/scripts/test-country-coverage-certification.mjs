...
if(report.counts.LIVE_DATA!==0||report.counts.DEGRADED!==1||report.counts.CONFIGURED!==584) throw new Error("Country-less runtime result must not mark a cell LIVE_DATA");
