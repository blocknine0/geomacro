...
const result=reconcileMineralEvidence({
  production:[
    ...
    {raw:{country_iso3:"COD",mineral:"cobalt",year:2024,evidence_type:"PRODUCTION",value:175,unit:"kilotonnes",source_id:"bgs"}}
  ],
  trade:[
...
assert.ok(result[0].conflicts.some(c=>c.type==="UNIT_CONFLICT"));
