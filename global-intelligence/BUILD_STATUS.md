...
- Added UN Comtrade trade-flow adapter with runtime ISO3→numeric reporter resolution from the official reference catalog, authenticated Data API vs public-preview selection, export/import normalization, derived trade-balance evidence, probe script, and source contract. Added a conservative critical-minerals HS starter catalog with explicit ambiguity flags. Complete 195-country reporter resolution, runtime PASS, full mineral concordance, freshness, and commercial/re-dissemination review remain open.
