...
- Added UN Comtrade trade-flow adapter with runtime ISO3→numeric reporter resolution from the official reference catalog, authenticated Data API vs public-preview selection, export/import normalization, derived trade-balance evidence, probe script, and source contract. Complete 195-country reporter resolution and runtime PASS are still certification requirements. Critical-mineral HS-code mapping and commercial/re-dissemination review are also still open.
