const RULES=[
  ...
  {category:"GEOPOLITICS",terms:/geopolitic|war|conflict|sanction|sanctions|tariff|election|government|military|security|diplomatic|treaty|protest|coup|border|shipping|strait|policy/i}
];
