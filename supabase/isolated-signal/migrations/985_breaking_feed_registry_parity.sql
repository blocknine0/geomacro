...
values
  ...
  ('aljazeera_rss','Al Jazeera RSS','Al Jazeera Media Network','GEOPOLITICS','RSS','NONE','https://www.aljazeera.com/xml/rss/all.xml',null,'REVIEW_REQUIRED',false,true,true,false,'GLOBAL','NEAR_REAL_TIME','Discovery/corroboration metadata only. No article body or publisher payload is commercially redistributed.'),
  ...
  ('federal_reserve_press_rss','Federal Reserve Press Releases','Board of Governors of the Federal Reserve System','MACRO','RSS','NONE','https://www.federalreserve.gov/feeds/press_all.xml',null,'REVIEW_REQUIRED',false,true,true,false,'USA','NEAR_REAL_TIME','Official-source lead/corroboration metadata only; downstream commercial delivery remains derived and rights-governed.'),
  ('forexlive_rss','ForexLive RSS','ForexLive','MACRO','RSS','NONE','https://www.forexlive.com/feed/news',null,'REVIEW_REQUIRED',false,true,true,false,'GLOBAL','NEAR_REAL_TIME','Discovery/corroboration metadata only. No article body or publisher payload is commercially redistributed.'),
  ...
  ('nrcan_news_atom','Natural Resources Canada News Releases Atom','Natural Resources Canada','CRITICAL_MINERALS','XML','NONE','https://api.io.canada.ca/io-server/gc/news/en/v2?dept=naturalresourcescanada&format=atom',null,'REVIEW_REQUIRED',false,true,true,false,'CAN','NEAR_REAL_TIME','Official Canadian government Atom discovery/corroboration feed, represented as XML in the registry; exact item reuse remains governed.'),
  ('usgs_minerals_news_rss','USGS Minerals News RSS','U.S. Geological Survey','CRITICAL_MINERALS','RSS','NONE','https://www.usgs.gov/news/minerals/feed','U.S. Government information; third-party material may have separate rights','REVIEW_REQUIRED',false,true,true,false,'USA','NEAR_REAL_TIME','Official USGS discovery/corroboration metadata only. Raw source content is not commercially redistributed.'),
  ('nws_active_alerts_atom','NWS Active Alerts ATOM','U.S. National Weather Service / NOAA','MULTI_DOMAIN','XML','NONE','https://api.weather.gov/alerts/active.atom','U.S. Government public-domain data; source acknowledgement expected','COMMERCIAL_OK',false,true,true,false,'USA','REAL_TIME','Official NWS CAP/ATOM active-alert index represented as XML in the registry and intended for redistribution and decision-support tools. Geomacro stores normalized lead metadata only and does not represent modified data as official NWS material.')
