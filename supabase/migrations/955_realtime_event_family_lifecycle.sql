-- =============================================================================
-- Geomacro authoritative production real-time flash lifecycle, category routing and event families
--
...
--
-- This is the authoritative application database contract. Raw fast-wire signal
-- intake remains isolated in the dedicated signal project; only compact,
-- verified lifecycle metadata is represented here.
-- =============================================================================
