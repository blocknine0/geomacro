-- =============================================================================
-- Geomacro set-based source certification evidence-graph promotion
-- =============================================================================
begin;
...
begin
  ...
  valueset as (
    select
      ...
      max(nullif(n.details->>'http_status','')::integer) filter(where n.dimension='ENDPOINT') endpoint_http_status,
      ...
      max(nullif(n.details->>'independent_source_count','')::integer) filter(where n.dimension='INDEPENDENCE') independent_source_count,
