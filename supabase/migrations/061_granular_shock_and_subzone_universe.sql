...
values
('SAHEL','Sahel','AFRICA','ecowas_press_releases','au_press_releases','reliefweb_reports_api'),
('GULF_OF_GUINEA','Gulf of Guinea','AFRICA','ecowas_press_releases','imo_maritime_safety_information','afdb_press_releases'),
('AFRICAN_GREAT_LAKES','African Great Lakes','AFRICA','eac_press_releases','igad_news','unhcr_global_public_api'),
('MAGHREB','Maghreb','AFRICA','arab_league_news','au_press_releases','un_security_council_docs_rss'),
('NILE_VALLEY','Nile Valley','AFRICA','au_press_releases','un_security_council_docs_rss','gdelt_v2_events'),
('HORN_OF_AFRICA','Horn of Africa','AFRICA','igad_news','unhcr_global_public_api','ukmto_msi'),
('SOUTHERN_AFRICA_COMMODITIES','Southern Africa commodities','AFRICA','sadc_news','afdb_press_releases','usgs_mcs'),
('RED_SEA','Red Sea','MIDDLE_EAST','ukmto_msi','marad_msci','gdacs_global_events_api'),
('ARABIAN_PENINSULA_GULF','Arabian Peninsula & Gulf','MIDDLE_EAST','gcc_news','eia_api_v2','qcb_placeholder'),
...
('EASTERN_MEDITERRANEAN','Eastern Mediterranean','MIDDLE_EAST','un_security_council_docs_rss','emsa_maritime_safety','imo_maritime_safety_information'),
('BLACK_SEA','Black Sea','EUROPE_EURASIA','marad_msci','emsa_maritime_safety','un_security_council_docs_rss'),
('BALTIC_SEA','Baltic Sea','EUROPE_EURASIA','nato_news','emsa_maritime_safety','ukmto_msi'),
('WESTERN_BALKANS','Western Balkans','EUROPE_EURASIA','osce_news','nato_news','eu_council_press_rss'),
('SOUTH_CAUCASUS','South Caucasus','EUROPE_EURASIA','traceca_intergovernmental','nato_news','un_security_council_docs_rss'),
('CENTRAL_EUROPE','Central Europe','EUROPE_EURASIA','eurostat_sdmx_api','eu_council_press_rss','ecb_press_rss'),
('NORDIC_ARCTIC_GATEWAY','Nordic Arctic gateway','EUROPE_EURASIA','nato_news','arctic_council_news','oecd_sdmx_api'),
('IBERIAN_ATLANTIC','Iberian Atlantic','EUROPE_EURASIA','eurostat_sdmx_api','emsa_maritime_safety','nato_news'),
...
('NORTH_ATLANTIC','North Atlantic','NORTH_AMERICA_EUROPE','emsa_maritime_safety','marad_msci','ukmto_msi'),
('ARCTIC','Arctic','POLAR','arctic_council_news','noaa_swpc','noaa_ncei_cdo_api'),
('ANTARCTIC','Antarctic','POLAR','antarctic_treaty_secretariat','noaa_ncei_cdo_api','copernicus_ems'),
('PACIFIC_ISLANDS','Pacific Islands','PACIFIC','pacific_islands_forum_news','adb_data_library','gdacs_global_events_api'),
('AUSTRALASIA','Australasia','PACIFIC','oecd_sdmx_api','amsa_marine_safety_information','rba_placeholder'),
('TRANSATLANTIC','Transatlantic','GLOBAL','emsa_maritime_safety','marad_msci','icpc_submarine_cables')
...
('currency_devaluation','Currency devaluation','currency_capital_mobility','HYBRID','imf_data_api','world_bank_indicators','monetary_placeholder'),
('hyperinflation_acceleration','Hyperinflation acceleration','macro_monetary','HYBRID','world_bank_indicators','imf_data_api','monetary_placeholder'),
...
('fx_convertibility_restriction','FX convertibility restriction','currency_capital_mobility','HYBRID','imf_data_api','gdelt_v2_events','monetary_placeholder'),
