...
--
-- last_seen_at: source/event publication chronology.
-- last_observed_at: latest time Geomacro observed the evidence in a verified
-- ingestion fragment. Current-signal freshness uses this field.
-- Strict Risk Object evidence age continues to use evidence_published_at.
-- ============================================================================
