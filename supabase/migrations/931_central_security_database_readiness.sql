-- =============================================================================
-- Geomacro real-funds database security readiness
--
-- This service-role-only probe verifies that security-critical production
-- tables exist, have RLS enabled, and expose no direct table privileges to
-- browser roles. It intentionally returns aggregate posture only.
-- =============================================================================
