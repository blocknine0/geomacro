...
const FEDERICO_STRICT_CORROBORATION_FAMILY_SCORE = 30
...
const GITHUB_OIDC_WORKFLOW_FILES = new Set([
  ...
  "global-realtime-production-repair.yml",
])
    ...
    try {
      ...
      const workflowFileAuthorized =
        ...
        (
          ...
          (
            payload.ref === "refs/heads/fix/global-realtime-source-runtime" &&
            payload.workflow === "global-realtime-production-repair.yml"
          )
        )

      const workflowRefBranchAuthorized =
