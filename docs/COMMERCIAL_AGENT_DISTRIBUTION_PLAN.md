...
The immediate milestone is launch readiness, not revenue activation. Coinbase, GOAT, Nevermined and any other real-money rail remain sandbox/testnet/disabled while all common production gates, discovery surfaces, adapters, observability, reconciliation and launch evidence are completed. Real-money services are activated together only after a final owner-approved launch decision.
